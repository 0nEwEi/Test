...
# torch.backends.cudnn.benchmark = True # not sure if it works
...
def main():
    ...
    # it seems achieving acceleration
    ...
    for epoch in range(config.NUM_EPOCHS):
        ...
        if config.SAVE_MODEL and epoch % 5 == 0:
            save_checkpoint(gen, opt_gen, filename=f"gen_{epoch}.ckpt")
            save_checkpoint(disc, opt_disc, filename=f"disc_{epoch}.ckpt")
